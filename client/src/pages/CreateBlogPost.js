...
export default class CreatePost extends Component {
  ...
  submitPost(e) {
    ...
    axios
      // .post('http://localhost:3030/new-post', newPost)
      .post('/api/new-post', newPost)
      .then(data => {
      ...
      .catch(err => {
        console.log(
          'You still need to implement your `POST` method on `/posts`',
          err
        );
      });
  }
  render() {
    return (
      <form className="Login-form">
        ...
        <button
          className="btn btn-sm btn-danger SubmitButton"
          type="submit"
